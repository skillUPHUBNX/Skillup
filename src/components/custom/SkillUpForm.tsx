            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="Graduated">Graduated / Pursuing</SelectItem>
                    <SelectItem value="Masters">Masters / Pursuing</SelectItem>
                    <SelectItem value="Diploma">Diploma / Pursuing</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage/>
              </FormItem>
